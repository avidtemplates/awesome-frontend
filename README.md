...
- [GeoIcons](https://github.com/getgeoicons/geoicons) - Tree-shakable geographic map icons for React, Vue, Angular, and vanilla JS. Every country, territory, and world region as its own named export.
